...
if __name__ == '__main__':
    ...
    resize_data_dir = './data/visa/resize_data/VisA/'
    ...
    for object_name in objects_list:
        ...
        #step1 sub-thread
        step1_saved_models_dir = './saved_models/step1_saved_models/VisA/'
        ...
        #step2 sub-thread
        python_script = './step2_pixel_ss_learning/main_visa_step2.py' 
        process = subprocess.Popen(['python', python_script, 
                                   '--object_name', object_name, 
