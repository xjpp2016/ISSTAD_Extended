...
import os
import random
from util.mvtecAD_aug import ImageAugmentation, Aug_old
...
def ob_p(args):
    ...
    if 'bracket_black' == args.object_name:
        args.p = 0.1
        args.w_m = 1
        args.w_r = 0.001
        args.num_epochs = 300
        args.rad_max = 2
        args.aug_type = 'old'
    elif 'bracket_brown' == args.object_name:
        args.p = 0.1
        args.w_m = 1
        args.w_r = 0.1
        args.num_epochs = 200
        args.rad_max = 2
        args.aug_type = 'new'
    elif 'bracket_white' == args.object_name:
        args.p = 0.1
        args.w_m = 1
        args.w_r = 0.01
        args.num_epochs = 200
        args.rad_max = 2
        args.aug_type = 'old'
    elif 'connector' == args.object_name:
        args.p = 0.1
        args.w_m = 1
        args.w_r = 1
        args.num_epochs = 200
        args.rad_max = 2
        args.aug_type = 'new'
    elif 'metal_plate' == args.object_name:
        args.p = 0.1
        args.w_m = 1
        args.w_r = 1
        args.num_epochs = 300
