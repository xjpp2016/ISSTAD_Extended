...
if __name__ == '__main__':
    ...
    for object_name in objects_list:
        ...
        #step1 sub-thread
        #step1_saved_models_dir = './saved_models/step1_saved_models/MPDD/'
        #python_script = './step1_mae_pretrain/main_mpdd_step1.py' 
        ...
        #step2 sub-thread
        python_script = './step2_pixel_ss_learning/main_mpdd_step2.py' 
        process = subprocess.Popen(['python', python_script, 
                                   '--object_name', object_name, 
