...
parser.add_argument('--train_data_dir', default='./data/MVTecAD/candle/train/good', type=str, help='image in training set')
parser.add_argument('--test_data_dir', default='./data/MVTecAD/candle/test', type=str, help='image in testing set')
parser.add_argument('--test_label_dir', default='./data/MVTecAD/candle/ground_truth', type=str)
